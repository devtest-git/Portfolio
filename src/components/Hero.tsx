    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-6 inline-block px-4 py-2 bg-blue-500/10 border border-blue-500/30 rounded-full">
          <p className="text-blue-400 text-sm font-medium">🚀 Cloud Engineer | DevOps Specialist</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-slate-800">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">Cloud Platforms</p>
          </div>
          <div>
            <p className="text-3xl font-bold text-pink-400">10+</p>
            <p className="text-slate-400 text-sm">Cloud Projects</p>
          </div>
        </div>
      </div>
    </section>
